...
type ParaPushReservationUpdateCycleSeat struct {
	ReservationUUID string `form:"reservationUUID" json:"reservationUUID" xml:"reservationUUID"  binding:"required"`
	OldCycleSeatLogUUID string `form:"oldCycleSeatLogUUID" json:"oldCycleSeatLogUUID" xml:"oldCycleSeatLogUUID"  binding:"required"`
}

func ValidatePushReservationUpdateCycleSeats(context *gin.Context) {
	var form ParaPushReservationUpdateCycleSeat
